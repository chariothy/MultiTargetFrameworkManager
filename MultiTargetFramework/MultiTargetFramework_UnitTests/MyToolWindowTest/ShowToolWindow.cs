...
using Nu.MultiTargetFramework;

namespace MultiTargetFramework_UnitTests.MyToolWindowTest
{
    [TestClass()]
    public class ShowToolWindowTest
    {
        ...
        {
            IVsPackage package = new MultiTargetFrameworkPackage() as IVsPackage;
            ...
            MethodInfo method = typeof(MultiTargetFrameworkPackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
